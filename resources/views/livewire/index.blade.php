            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="#about"
                       ...
                       class="text-slate-600 dark:text-zinc-300 hover:text-amber-600 dark:hover:text-amber-400 transition-colors px-4 py-2 rounded-lg hover:bg-amber-50 dark:hover:bg-zinc-800 cursor-pointer">
